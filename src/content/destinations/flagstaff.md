...
essentials:
  ...
  - icon: "📍"
    ...
    value: "Phoenix Sky Harbor (PHX), 2.5 hrs"
  - icon: "🌲"
    label: "Best For"
    value: "Hiking, stargazing, Route 66 culture"
  - icon: "📅"
    label: "Peak Season"
    value: "June–September"
highlights:
  - "Stargaze at Lowell Observatory, where Pluto was discovered"
  - "Summit Humphreys Peak, Arizona's highest point at 12,637 feet"
  - "Ski or ride at Arizona Snowbowl with panoramic views"
  - "Walk among 800-year-old cliff dwellings at Walnut Canyon"
  - "Explore ancient pueblos at Wupatki National Monument"
  - "Cruise the most iconic stretch of Historic Route 66"
gradientColors: "from-emerald-900 via-green-800 to-teal-900"
relatedDestinations:
  - grand-canyon
  - sedona
  - page
...
**Humphreys Peak** is Arizona's rooftop at 12,637 feet. The Humphreys Trail is a 10-mile round trip that gains about 3,300 feet of elevation. It is strenuous but non-technical, and the views from above treeline are extraordinary. Start early to beat afternoon thunderstorms in summer.
...
**Mid-range visitors** will find strong value at the Drury Inn & Suites Flagstaff, where rates hover around $130–$160 and include a hot breakfast and evening snacks with drinks. The Hotel Monte Vista, built in 1927 and supposedly haunted, offers rooms from $110 with unbeatable Route 66 atmosphere.
...
**Coppa Cafe** on North San Francisco Street does outstanding Italian-inspired breakfasts and lunches. The ricotta pancakes are a standout, and portions are generous. Plan on $12–$18 per person.

**Tourist Home All Day Cafe** in a converted 1926 bungalow south of the tracks serves some of the best brunch in northern Arizona. The chilaquiles and the lavender latte are both worth the wait for a table. Meals run $14–$20.

**MartAnne's Burrito Palace** on East Phoenix Avenue is a Flagstaff institution, serving enormous breakfast burritos smothered in green chile for under $12. Cash only, and the line moves fast.

**Mother Road Brewing Company** on East Route 66 is my go-to for craft beer and a casual bite. The Tower Station IPA is a flagship for good reason, and the food truck parked outside usually has solid tacos or burgers. Pints run $6–$8.
