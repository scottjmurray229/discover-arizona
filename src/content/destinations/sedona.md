...
budgetPerDay:
  ...
  midRange: 180
  luxury: 500
gettingThere: "Sedona is about 115 miles north of Phoenix, a roughly two-hour drive via I-17 North to AZ-179 (the scenic route through Village of Oak Creek) or AZ-89A (through Cottonwood and the switchbacks of upper Oak Creek Canyon). From Flagstaff, it's a stunning 30-mile drive south through Oak Creek Canyon on AZ-89A — one of the most scenic drives in America. The nearest commercial airport is Flagstaff Pulliam (FLG), 45 minutes north, though most visitors fly into Phoenix Sky Harbor (PHX)."
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Mild desert climate; 55-85°F in spring/fall, 95-100°F in summer, 35-55°F in winter"
  - icon: "💵"
    label: "Red Rock Pass"
    value: "$5/day or $15/week for trailhead parking in Coconino National Forest"
  - icon: "🕐"
    label: "Time Zone"
    value: "Mountain Standard Time year-round (Arizona does not observe DST)"
  - icon: "📶"
    label: "Connectivity"
    value: "Good cell coverage in town; spotty on trails and in canyons"
  - icon: "🅿️"
    label: "Parking"
    value: "Arrive before 8 AM for popular trailheads; overflow lots fill fast on weekends"
  - icon: "🚗"
    label: "Getting Around"
    value: "A car is essential; Sedona Trolley offers narrated tours of major sites"
highlights:
  - "Hike to the top of Cathedral Rock at sunrise for panoramic red rock views"
  - "Cross the natural stone bridge on the Devil's Bridge Trail"
  - "Experience the energy vortex sites at Airport Mesa and Boynton Canyon"
  - "Browse galleries and artisan shops at Tlaquepaque Arts & Shopping Village"
  - "Take a Pink Jeep Tour through Broken Arrow or Diamondback Gulch"
  - "Swim in the natural rock pools at Slide Rock State Park"
gradientColors: "from-red-900 via-orange-700 to-amber-800"
relatedDestinations:
  - grand-canyon
  - flagstaff
  - scottsdale
...
Sedona sits at about 4,350 feet in the Verde Valley, which gives it a milder climate than the low desert around Phoenix and a more dramatic landscape than just about anywhere else in the state. It's become a destination for hikers, artists, spiritual seekers, and anyone who just wants to be surrounded by stunning natural beauty. And despite its reputation as a tourist town, it's remarkably easy to find solitude once you get a quarter-mile down any trail.
...
**Devil's Bridge Trail** leads to the largest natural sandstone arch in the area, and the photo from the bridge itself has become one of Arizona's most iconic images. The trail is about 4 miles round trip from the main parking area, or 2 miles if you access it via the Dry Creek Road trailhead (high-clearance vehicle recommended). The bridge itself is broad and sturdy but exposed — not ideal if you have a fear of heights.
...
**Boynton Canyon Trail** is a 6.1-mile round trip hike that takes you deep into one of Sedona's most beautiful box canyons. The trailhead also accesses the Boynton Canyon Vortex site about a quarter-mile in. This one stays cooler in summer thanks to the canyon shade.

**Pink Jeep Tours** are a Sedona institution. The Broken Arrow tour ($110-130 per person for about two hours) is the most popular, bouncing over rugged terrain past Submarine Rock and the Chapel of the Holy Cross area. The guides are knowledgeable and entertaining, and the off-road access takes you places you simply can't reach on foot or in a regular vehicle.

**Tlaquepaque Arts & Shopping Village** is styled after a traditional Mexican village, with vine-covered stucco walls, cobblestone walkways, and over 50 galleries and boutiques. It's touristy, absolutely, but the craftsmanship on display is legitimate. I always stop at Kuivato Glass Gallery to watch the live glassblowing demonstrations. Free to wander.
...
**L'Auberge de Sedona** sits along Oak Creek in the heart of town, with creekside cottages starting around $350-500 per night. The on-site restaurant, Etch Kitchen & Bar, is one of the best in Sedona. Request a creekside room — falling asleep to the sound of the creek is a luxury money can buy.
...
**Creekside Coffee** in Uptown Sedona is my go-to morning stop — great espresso drinks ($4-7) with a small patio overlooking Oak Creek. Pair it with one of their pastries for a solid start to a hiking day.
