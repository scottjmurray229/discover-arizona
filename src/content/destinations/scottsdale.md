...
budgetPerDay:
  ...
  midRange: 200
  luxury: 600
gettingThere: "Scottsdale sits immediately east of Phoenix, and Phoenix Sky Harbor International Airport (PHX) is just 10-15 minutes from downtown Scottsdale. Scottsdale Airport (SDL) handles private and charter flights. From downtown Phoenix, Scottsdale Road heads straight north into Old Town in about 20 minutes. From Sedona, it's roughly a 2-hour drive south on AZ-179 to I-17 to the Loop 101. The Scottsdale Trolley provides free service through Old Town and the waterfront area."
essentials:
  - icon: "🌡️"
    label: "Climate"
    value: "Hot desert; 65-80°F Nov-Mar, 100-115°F Jun-Sep with dry heat"
  - icon: "💵"
    label: "Resort Season"
    value: "Peak rates Nov-Apr; summer rates drop 40-60% at luxury resorts"
  - icon: "🕐"
    label: "Time Zone"
    value: "Mountain Standard Time year-round (Arizona does not observe DST)"
  - icon: "📶"
    label: "Connectivity"
    value: "Excellent cell and Wi-Fi throughout; resorts have strong connectivity"
  - icon: "⛳"
    label: "Golf"
    value: "200+ golf courses in the greater Scottsdale area, many open year-round"
  - icon: "🚐"
    label: "Free Trolley"
    value: "Scottsdale Trolley runs free service through Old Town, Arts District, and Waterfront"
highlights:
  - "Explore the galleries, boutiques, and western saloons of Old Town Scottsdale"
  - "Hike the pristine McDowell Sonoran Preserve on over 225 miles of trails"
  - "Indulge in a world-class spa day at one of Scottsdale's legendary resorts"
  - "Play a round at TPC Scottsdale, home of the WM Phoenix Open"
  - "Experience Scottsdale's vibrant nightlife along the Entertainment District"
  - "Watch Cactus League spring training baseball in February and March"
gradientColors: "from-amber-800 via-yellow-700 to-orange-800"
relatedDestinations:
  - phoenix
  - sedona
  - tucson
