...
heroVideo: ""
heroImage: ""
tagline: "Where Water Meets Desert"
region: northern
bestMonths:
  - March
  - April
...
budgetPerDay:
  ...
  midRange: 140
  luxury: 350
gettingThere: "Page Municipal Airport (PGA) has limited seasonal service. Most visitors drive from Flagstaff (2.5 hours via US-89) or from Phoenix (4.5 hours via I-17 and US-89). Page is also a common stop on the Grand Circle road trip route. No public transit connects Page to other cities."
essentials:
  - icon: "🌡️"
    label: "Elevation"
    value: "4,118 feet (1,255 m)"
  - icon: "🕐"
    label: "Time Zone"
  ...
  - icon: "📍"
    ...
    value: "Flagstaff, AZ (2.5 hrs)"
  - icon: "🏜️"
    label: "Best For"
    value: "Slot canyons, photography, Lake Powell"
  - icon: "📅"
    label: "Peak Season"
    value: "March–May, September–October"
highlights:
  - "Walk through the light beams of Upper Antelope Canyon"
  - "Stand at the edge of Horseshoe Bend's 1,000-foot drop"
  - "Cruise Lake Powell's 1,960 miles of shoreline"
  - "Tour the massive Glen Canyon Dam from the inside"
  - "Boat to Rainbow Bridge, the world's largest natural bridge"
  - "Photograph the swirling sandstone of Lower Antelope Canyon"
gradientColors: "from-orange-900 via-red-800 to-amber-900"
relatedDestinations:
  - grand-canyon
  - monument-valley
  - flagstaff
...
Page sits at the center of a geological showcase that took millions of years to create. Within a 15-mile radius of town, you can walk through slot canyons so narrow you can touch both walls, stand on the rim of a 1,000-foot horseshoe-shaped cliff, cruise across one of America's largest reservoirs, and visit an engineering marvel that reshaped the entire Colorado River system. The concentration of world-class natural attractions in such a small area is staggering.
...
**Lower Antelope Canyon** is narrower, deeper, and requires climbing ladders and squeezing through tight passages. I actually preferred it — fewer crowds and equally stunning formations. Ken's Tours and Dixie Ellis' Lower Antelope Canyon Tours are the main operators. Expect to pay $40–$55 per person.

**Horseshoe Bend** is a 1.5-mile round trip walk from the parking lot on US-89 to an overlook where the Colorado River makes a dramatic 270-degree turn around a sandstone mesa, 1,000 feet below. The parking fee is $10 per vehicle. Go at sunrise or sunset for the best light and smaller crowds. There are railings now, but the exposure is still intense — keep a firm grip on cameras and children.

**Lake Powell** is a 186-mile-long reservoir with 1,960 miles of shoreline, more than the entire Pacific coast of the United States. Wahweap Marina, just 5 miles from town, rents powerboats, kayaks, and paddleboards. A half-day powerboat rental starts around $400. Guided boat tours to Rainbow Bridge National Monument, the world's largest natural bridge at 290 feet tall, run approximately $130–$180 per person for a full-day trip.

**Glen Canyon Dam** is a 710-foot concrete arch dam that created Lake Powell when it was completed in 1966. The Carl Hayden Visitor Center at the dam is free to enter and offers excellent exhibits on the dam's construction and the ecology of the Colorado River. Guided dam tours (when available) take you inside the structure for about $5 per person.
...
**Mid-range visitors** will find consistent quality at the Hyatt Place Page Lake Powell, where rooms run $130–$180 and include breakfast. The Best Western View of Lake Powell, on the hill above town, offers solid rooms with panoramic views for $120–$170.
...
**El Tapatio** on South Lake Powell Boulevard serves reliable Mexican food with generous portions. The carne asada tacos and green chile burrito are my go-to orders. Meals run $10–$16.

**Bonkers Restaurant** downtown is the closest thing Page has to fine dining. The steaks and seafood are well-prepared, and the wine list is decent for a town this size. Entrees run $22–$38.

**Blue Buddha Sushi Lounge** on North Navajo Drive is an unexpected find. The sushi is surprisingly fresh given that you are in the middle of the desert, and the atmosphere is lively. Rolls run $12–$18.

**Ranch House Grille** on South Lake Powell Boulevard does a proper American breakfast — eggs, bacon, pancakes, and strong coffee. It gets packed on weekend mornings, so arrive early. Breakfast runs $10–$15.
